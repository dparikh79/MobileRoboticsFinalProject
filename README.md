...
Robotics at Northeastern, MS Robotics, Spring 2021) is maintained as the
canonical version inside the sibling repo:

**https://github.com/dparikh79/mobile_robotics** (see `MobileRoboticsFinalProject/`)

The sibling repo carries:

- A full write-up of the lab and the final project (stack, run book, results, takeaways).
